...
class Start(QuestSegment):
    ...
    def play(self):
        msg = ('{} and {} are pinned down by a Noxian archer! '
    ...
    def move(self, display_name, direction):
        ...
        if self.quest.first_action:
            ...
            if direction == self.quest.first_action:
                ...
                msg = ('{0} and {1} apparently suck at coordination and both ended up going the same direction. '
                ...
                msg = ('{0} and {1} skillfully flank the archer and eviscerate him! Easy games easy life. '
    ...
    def timeout(self):
        if self.quest.first_action:
            ...
            msg = ('Neither {0} nor {1} want to make a move, and eventually both get picked off like sitting ducks. '
                   'Rekt. Both lose {2} gold.'.format(self.quest.party[0], self.quest.party[1], GOLD_PENALTY))
            self.channel.send_msg(msg)
